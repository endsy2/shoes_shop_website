...
let AdminController = class AdminController {
    ...
    async InsertBrand(file, insertbrandDTO) {
        if (!file) {
            throw new common_1.BadRequestException('You must input an image');
        }
    ...
    async uploadFile(file) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(error || 'File upload failed');
        }
    }
    async InsertCategory(insertCategoryDTO) {
        return this.productService.insertCategory(insertCategoryDTO);
    }
    async InsertVariant(files, insertVariantDIO) {
        const images = [];
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "displayBrand", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array,
        InsertVariant_dto_1.insertVariantDTO]),
    __metadata("design:returntype", Promise)
