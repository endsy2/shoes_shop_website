...
const Register = () => {
  return (
    <section >
      <h2 className="font-AntonSC font-bold text-center text-[white] text-5xl block mt-7 dark:text-primary-600 ">Register</h2>
      <div className="flex flex-col justify-center items-center p-10 ">
        <form action="submit" className="flex flex-col items-center justify-center" >
          <div className="flex flex-col ">
            <label className="text-login text-lg font-bold dark:text-primary-600 ">Email</label>
          ...
          <div className="flex flex-col ">
            <label className="text-login text-lg font-bold dark:text-primary-600">Password</label>
          ...
          <div className="flex flex-col ">
            <label className="text-login text-lg font-bold dark:text-primary-600">Confirm Password</label>
            <input type=" password" placeholder="Comfirm Password" className="text-black dark:placeholder:text-primary-600 text-lg rounded-lg w-[500px] h-12 p-4 dark:border-primary border-2 focus:border-primary-600 focus:ring-2  focus:outline-none" /><br /><br />
          </div>
        </form>
