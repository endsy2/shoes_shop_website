...
const Login = () => {
  return (
    <section>
      <h2 className="font-AntonSC font-bold text-center dark:text-[white] text-5xl block mt-10 text-primary-600">Login</h2>
      <div className="flex flex-col align-center items-center p-10 ">
        <form action="submit" className="flex flex-col" >
          <div className="flex flex-col">
            <label className="text-login font-bold text-xl pb-4 text-primary-600">Email</label>
          ...
          <div className="flex flex-col">
            <label className="text-login font-bold text-xl pb-4 text-primary-600">Password</label>
