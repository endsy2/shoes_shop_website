...
import { datatableOrder } from "../Constants/fakeData.js";
    ...
    return (
        <section className="mt-16 bg-white rounded-lg p-6 sm:p-10 shadow-lg border border-gray-400">
            <section className="flex flex-col sm:flex-row justify-between mx-4 sm:mx-10 mb-5 sm:mb-10">
                <h1 className="text-primary green-text mt-4 sm:mt-10 font-semibold text-lg lg:text-3xl">
                    {title}
                </h1>
            ...
            <div className="overflow-x-auto">
                <table className="table-auto w-full border-separate border-spacing-0">
                    ...
                    <tbody>
                        {Array.isArray(datatableOrder) && datatableOrder.length > 0 ? (
                            datatableOrder.data.map((element) => (
                                <tr
