  ...
  return (
    <nav className="flex-col w-full">
      ...
      <section className="bg-lightGray w-full h-20">
        <ol className="flex justify-start md:justify-center items-center w-full h-full gap-16 px-4 text-[white] text-xl overflow-x-scroll md:overflow-x-hidden  overflow-y-hidden whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 snap-x snap-mandatory">
          {menubar.map(({ label, items }) => (
            <li key={label} className="relative group flex-shrink-0 snap-center">
              {/* Menu Label */}
